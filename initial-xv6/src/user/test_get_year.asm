...
user/_test_get_year:     file format elf64-littleriscv
...
int main(void){
   ...
   6:	0800                	addi	s0,sp,16
	printf("unix was released in the year %d\n",getyear());
   8:	00000097          	auipc	ra,0x0
   c:	35a080e7          	jalr	858(ra) # 362 <getyear>
  10:	85aa                	mv	a1,a0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c2:	4ca50513          	addi	a0,a0,1226 # 888 <digits>
 3c6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 482:	3b2c8c93          	addi	s9,s9,946 # 830 <malloc+0x124>
 ...
 490:	3fcb8b93          	addi	s7,s7,1020 # 888 <digits>
 ...
 5b6:	27698993          	addi	s3,s3,630 # 828 <malloc+0x11c>
        while(*s != 0){
 5ba:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 7e6:	b58080e7          	jalr	-1192(ra) # 33a <sbrk>
  if(p == (char*)-1)
