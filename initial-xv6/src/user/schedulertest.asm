...
printint(int fd, int xx, int base, int sgn)
{
 ...
 476:	4d650513          	addi	a0,a0,1238 # 948 <digits>
 47a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 536:	3bec8c93          	addi	s9,s9,958 # 8f0 <malloc+0x130>
 ...
 544:	408b8b93          	addi	s7,s7,1032 # 948 <digits>
 ...
 66a:	28298993          	addi	s3,s3,642 # 8e8 <malloc+0x128>
        while(*s != 0){
 66e:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 89a:	b58080e7          	jalr	-1192(ra) # 3ee <sbrk>
  if(p == (char*)-1)
