...
void periodic()
{
  ...
  26:	a6a080e7          	jalr	-1430(ra) # a8c <printf>
    // for(int i=0;i<10;i++){printf("%d",i);sleep(1);}
    sigreturn();
...
void slow_handler()
{
  ...
  5c:	be050513          	addi	a0,a0,-1056 # c38 <malloc+0xf4>
  ...
  a2:	ba250513          	addi	a0,a0,-1118 # c40 <malloc+0xfc>
...
00000000000000dc <test0>:
{
  ...
  f2:	b8a50513          	addi	a0,a0,-1142 # c78 <malloc+0x134>
 ...
 11e:	2409091b          	addiw	s2,s2,576 # f4240 <base+0xf3230>
            write(2, ".", 1);//printf(" %d ",i);
 122:	00001a97          	auipc	s5,0x1
 126:	b66a8a93          	addi	s5,s5,-1178 # c88 <malloc+0x144>
        if (count > 0){
 ...
 17e:	b1650513          	addi	a0,a0,-1258 # c90 <malloc+0x14c>
 ...
 1a0:	b0450513          	addi	a0,a0,-1276 # ca0 <malloc+0x15c>
...
00000000000001ae <foo>:
{
 ...
 1de:	aae58593          	addi	a1,a1,-1362 # c88 <malloc+0x144>
 1e2:	4509                	li	a0,2
...
00000000000001ee <test1>:
{
 ...
 202:	ae250513          	addi	a0,a0,-1310 # ce0 <malloc+0x19c>
 ...
 278:	aac50513          	addi	a0,a0,-1364 # d20 <malloc+0x1dc>
 ...
 298:	a5c50513          	addi	a0,a0,-1444 # cf0 <malloc+0x1ac>
 29c:	00000097          	auipc	ra,0x0
 2a0:	7f0080e7          	jalr	2032(ra) # a8c <printf>
 2a4:	b7c5                	j	284 <test1+0x96>
        printf("test1 passed\n");
 2a6:	00001517          	auipc	a0,0x1
 2aa:	aba50513          	addi	a0,a0,-1350 # d60 <malloc+0x21c>
...
00000000000002b8 <test2>:
{
 ...
 2ce:	aa650513          	addi	a0,a0,-1370 # d70 <malloc+0x22c>
 ...
 32a:	a5a50513          	addi	a0,a0,-1446 # d80 <malloc+0x23c>
 ...
 38e:	a0e50513          	addi	a0,a0,-1522 # d98 <malloc+0x254>
 ...
 3b2:	a1250513          	addi	a0,a0,-1518 # dc0 <malloc+0x27c>
...
void test3()
{
 ...
 3d6:	3d0080e7          	jalr	976(ra) # 7a2 <sigalarm>
    printf("test3 start\n");
 3da:	00001517          	auipc	a0,0x1
 3de:	9f650513          	addi	a0,a0,-1546 # dd0 <malloc+0x28c>
 ...
 40c:	9d850513          	addi	a0,a0,-1576 # de0 <malloc+0x29c>
 ...
 424:	9e850513          	addi	a0,a0,-1560 # e08 <malloc+0x2c4>
